...
export default class Profile extends Component {
  ...
  setAvatar = () => {
    // this.setState({ avatar: BACKEND_URL.slice(0, BACKEND_URL.length - 4) + this.state.currentUser.photo });
  ...
  setInfo = () => {
    ...
    //   company: this.state.currentUser.company ? this.state.currentUser.company : "",
    // });
  };
  ...
  handleInfoSave = () => {
    ...
    if (submitFlag) {
      ...
      // axios({
      //   method: "post",
      //   url: `${BACKEND_URL}auth/updateProfile`,
      //   data: formData,
      ...
      //       axios
      //         .get(`${BACKEND_URL}auth/getProfile`, {
  ...
  handlePassSave = () => {
    ...
    if (submitFlag) {
      ...
      //       $("#cancelPass").click();
      //     } else {
      //       if (response.data.message == "ValidationError") {
